...
-- support an annotation like the following. Consult your cerver documentation.
...
local theme = lush(function(injected_functions)
	...
	return {
		...
		NormalFloat({ bg = hsl("#ebe0f5") }), -- Normal text in floating windows.
		...
		DiagnosticInfo({ fg = hsl("#ff85ab") }), -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
